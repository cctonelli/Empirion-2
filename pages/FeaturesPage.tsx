    ...
    <div className="min-h-screen relative bg-[#F1F5F9] text-slate-900 font-sans overflow-x-hidden selection:bg-orange-500/30">
      ...
      <div className="container mx-auto px-4 md:px-10 relative z-10 pt-32 pb-24">
        ...
        <header className="text-center mb-20 space-y-4">
           <h1 className="text-4xl md:text-6xl font-black text-slate-900 uppercase tracking-tighter leading-none italic pr-4 select-none">
              Empirion: A Nova Era da Simulação Empresarial com <span className="inline-block text-orange-600 pr-3 pb-1">Inteligência Artificial</span>
           </h1>
