         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {content.themes?.map((theme: any, i: number) => (
              <motion.div 
                ...
                className="bg-slate-900/50 p-12 rounded-[4rem] border border-white/5 hover:border-white/20 transition-all group shadow-2xl relative overflow-hidden"
              >
                 ...
                 <div className="flex items-center gap-6 mb-10 relative z-10">
                    ...
                    <h3 className="text-2xl font-black text-white uppercase italic leading-none">{theme.title}</h3>
                 </div>
