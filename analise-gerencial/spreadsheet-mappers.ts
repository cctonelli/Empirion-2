...
const mapKardexReport = (periods: any[], startingMode?: string): TableData => {
  ...
  const kardexDefinitions = [
    ...
    { category: 'Matéria-Prima A (Fluxo Físico e Financeiro WAC)', key: 'mpa.saldoInicialValor', label: 'Estoque Inicial (Valor)' },
    { category: 'Matéria-Prima A (Fluxo Físico e Financeiro WAC)', key: 'mpa.entradasQtd', label: 'Entradas Compras (Qtd)' },
    { category: 'Matéria-Prima A (Fluxo Físico e Financeiro WAC)', key: 'mpa.entradasValor', label: 'Entradas Compras (Valor)' },
    { category: 'Matéria-Prima A (Fluxo Físico e Financeiro WAC)', key: 'mpa.saidasQtd', label: 'Saídas Consumo (Qtd)' },
    { category: 'Matéria-Prima A (Fluxo Físico e Financeiro WAC)', key: 'mpa.saidasValor', label: 'Saídas Consumo (Valor)' },
    { category: 'Matéria-Prima A (Fluxo Físico e Financeiro WAC)', key: 'mpa.saldoFinalQtd', label: 'Estoque Final (Qtd)' },
    { category: 'Matéria-Prima A (Fluxo Físico e Financeiro WAC)', key: 'mpa.saldoFinalValor', label: 'Estoque Final (Valor)' },
    ...
    { category: 'Matéria-Prima B (Fluxo Físico e Financeiro WAC)', key: 'mpb.saldoInicialValor', label: 'Estoque Inicial (Valor)' },
    { category: 'Matéria-Prima B (Fluxo Físico e Financeiro WAC)', key: 'mpb.entradasQtd', label: 'Entradas Compras (Qtd)' },
    { category: 'Matéria-Prima B (Fluxo Físico e Financeiro WAC)', key: 'mpb.entradasValor', label: 'Entradas Compras (Valor)' },
    { category: 'Matéria-Prima B (Fluxo Físico e Financeiro WAC)', key: 'mpb.saidasQtd', label: 'Saídas Consumo (Qtd)' },
    { category: 'Matéria-Prima B (Fluxo Físico e Financeiro WAC)', key: 'mpb.saidasValor', label: 'Saídas Consumo (Valor)' },
    ...
    { category: 'Produtos Acabados (Movimentação e Custo Comercial WAC)', key: 'pa.saldoInicialValor', label: 'Estoque Inicial PA (Valor)' },
    { category: 'Produtos Acabados (Movimentação e Custo Comercial WAC)', key: 'pa.entradasQtd', label: 'Entradas Produção (Qtd)' },
    { category: 'Produtos Acabados (Movimentação e Custo Comercial WAC)', key: 'pa.entradasValor', label: 'Entradas Produção (Valor/CPP)' },
    { category: 'Produtos Acabados (Movimentação e Custo Comercial WAC)', key: 'pa.saidasQtd', label: 'Saídas Vendas / CPV (Qtd)' },
    { category: 'Produtos Acabados (Movimentação e Custo Comercial WAC)', key: 'pa.saidasValor', label: 'Saídas Vendas / CPV (Valor)' },
    { category: 'Produtos Acabados (Movimentação e Custo Comercial WAC)', key: 'pa.saldoFinalQtd', label: 'Estoque Final PA (Qtd)' },
    { category: 'Produtos Acabados (Movimentação e Custo Comercial WAC)', key: 'pa.saldoFinalValor', label: 'Estoque Final PA (Valor)' },
