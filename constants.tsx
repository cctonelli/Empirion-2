...
export const APP_VERSION = "v15.40.0-Oracle-Industrial-IVA";
export const BUILD_DATE = "03/02/2026";
export const PROTOCOL_NODE = "Node 08-STREET-INDUSTRIAL-IVA";
 ...
 * ATENÇÃO: INCLUSÃO DE CONTAS DE COMPENSAÇÃO DE IVA v15.40
 * ==============================================================================
 */
...
export const DEFAULT_MACRO: MacroIndicators = {
  ...
  tax_rate_ir: 25.0,
  vat_purchases_rate: 0.0, // IVA sobre Compras inicial
  vat_sales_rate: 0.0,     // IVA sobre Vendas inicial
