...
const OFFICIAL_PRESETS: any[] = [
  {
    ...
    config: {
      ...
      profit_incorporation_frequency: 1,
      clients_initial: 0,
      custom_pecld_val: 0,
      suppliers_initial: 0,
      taxes_initial: 0,
      ...
      const champ = await createChampionshipWithTeams(
        {
          ...
          region_configs: tutorConfig.regions.map((r) => ({
            ...
            suggested_price: r.suggested_price !== undefined ? Number(r.suggested_price) : 425.0,
            distribution_cost: r.distribution_cost !== undefined ? Number(r.distribution_cost) : 50.0,
            marketing_cost: r.marketing_cost !== undefined ? Number(r.marketing_cost) : 10000.0,
          })),
