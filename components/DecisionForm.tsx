    ...
    if (presetType === 'conservadora') {
      setDecisions(prev => {
        ...
        next.hr = {
          ...
          hired: 0,
          fired: 5,
          salary: Math.max(1800, currentMacro?.min_salary || 2000),
          trainingPercent: 1.5,
      ...
      setDecisions(prev => {
        ...
        next.hr = {
          ...
          hired: 5,
          fired: 0,
          salary: Math.round((currentMacro?.min_salary || 2000) * 1.1),
          trainingPercent: 4.5,
      ...
      setDecisions(prev => {
        ...
        next.hr = {
          ...
          hired: 15,
          fired: 0,
          salary: Math.round((currentMacro?.min_salary || 2000) * 1.25),
          trainingPercent: 8,
         ...
         <div className="flex items-center gap-6">
            <div className="flex flex-col">
               ...
               <h2 className="text-xl font-black text-white uppercase italic tracking-tighter mt-0.5">
                  Team: <span className="text-slate-400 drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">{activeTeam?.name}</span>
               </h2>
            </div>
                     ...
                     <div className="flex-1 flex flex-col h-full overflow-hidden relative">
                        ...
                        <div ref={scrollContainerRef} className="flex-1 overflow-y-auto custom-scrollbar p-4 lg:p-6 bg-slate-950/40 relative">
                           <div className="w-full mx-auto pb-40 space-y-8 px-2">
                              ...
                              {activeStep === 1 && (
                                <MarketingStep decisions={decisions} updateDecision={updateDecision} replicateInCluster={replicateInCluster} activeArena={activeArena} isReadOnly={isReadOnly} />
                              )}
