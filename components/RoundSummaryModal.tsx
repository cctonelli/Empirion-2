            ...
            {isLockedWaiting ? (
              ...
              <div className="text-center space-y-6 py-6" id="locked_waiting_view">
                ...
                <p className="text-slate-300 max-w-xl mx-auto text-sm leading-relaxed">
                  O cronômetro fiduciário encerrou para o período **P-{roundNumber < 10 ? '0' : ''}{roundNumber}**. Suas decisões vigentes foram transmitidas com sucesso de maneira síncrona. O Oráculo está aguardando o processamento do Turnover pelo Tutor para liberar os relatórios fiscais e as apurações de mercado do próximo ciclo.
                </p>
                ...
                <div className="bg-slate-950/50 border border-white/5 p-6 rounded-2xl max-w-lg mx-auto text-left flex gap-4 items-center">
                  ...
                  <p className="text-xs text-slate-400 leading-snug">
                    ...
                    Sua equipe não conseguirá alterar as decisões do período P-{roundNumber < 10 ? '0' : ''}{roundNumber} a partir de agora. Aproveite para revisar o planejamento contábil da empresa.
                  </p>
                </div>
