...
-- 1. ADIÇÃO DE COLUNA DE DEPRECIAÇÃO ACUMULADA EM COMPANIES (LIVE)
ALTER TABLE public.companies 
ADD COLUMN IF NOT EXISTS fixed_assets_depreciation NUMERIC(20,2) DEFAULT 0;

-- 2. ADIÇÃO DE COLUNA DE DEPRECIAÇÃO ACUMULADA EM TRIAL_COMPANIES (SANDBOX)
ALTER TABLE public.trial_companies 
ADD COLUMN IF NOT EXISTS fixed_assets_depreciation NUMERIC(20,2) DEFAULT 0;

-- 3. ÍNDICES PARA MONITORAMENTO DE "SAÚDE DOS ATIVOS"
...
-- Permite ver rapidamente quem está com parque de máquinas sucateado
...
SELECT 
    ...
    CASE 
        WHEN c.fixed_assets_value = 0 THEN 0 
