...
SET kpis = COALESCE(kpis, '{}'::jsonb) || jsonb_build_object(
    ...
    'import_tariff_brazil', COALESCE(import_tariff_brazil, 0),
    'import_tariff_uk', COALESCE(import_tariff_uk, 0),
...
ALTER TABLE public.companies
    ...
    DROP COLUMN IF EXISTS import_tariff_brazil,
    DROP COLUMN IF EXISTS import_tariff_uk,
